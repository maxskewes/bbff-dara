  ...
  return (
    <PageContainer heading={"THIS YEAR'S LINEUP"}>
      ...
      <SimpleGrid columns={[1, null, null]} spacing={[1]}>
        ...
        <FullArtistBox
          bandname={'The LEWIS & CLARKE EXPEDITION'}
        ...
        >
          ...
          began. Linda’s experience as a lead singer in several Portland-area
          ...
          his inventive multi-genre Scruggs/Melodic style banjo playing. Their
          mix draws from Bluegrass, Classic Country, originals and 70’s one hit
        ...
        >
          Bluegrass Mando/Guitar Duo. Interesting factoid: Pat and Jo were born
          concentric twins from a Bill Monroe and Charlie Parker's illegitimate
          man baby. Obviously Bill carried the pair to term but upon excising
          them from his womb, as Charlie's eyes swelled with tears (not so much
          from lover but from and excess of alcohol consumed), Bill exclaimed,
