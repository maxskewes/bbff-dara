    ...
    <PageContainer heading={"THIS YEAR'S LINEUP"}>
      ...
      <SimpleGrid columns={[1, null, null]} spacing={[1]}>
        ...
        >
          ...
          reprises ranging from Iron Maiden to Bill Monroe. The band first
          formed for a benefit show from a hodgepodge of musicians living in
          Eugene&apos;s infamous Campbell Club Cooperative on Alder Street.Over
          the years Alder Street blossomed in Eugene's infamous local music
          scene.
        </FullArtistBox>
        ...
        >
          ...
          Withers at Artichoke Music, a Portland instrument store. Six records
          and 27 years later, the band has toured throughout the United States,
          playing roadhouses, clubs, listening rooms and festivals. Along the
          way, they&apos;ve shared bills with bluegrass greats such as Del
          McCoury and Tim O&apos;Brien and welcomed legends like Danny Barnes
          and Tony Furtado as temporary band mates. The band&apos;s devoted
          following includes bluegrass purists, alt-country fans, kids looking
          to dance, and people who know a good tune when they hear one.
          Jackstraw has developed a reputation over the years for their
        ...
        >
          ...
          bluegrass cats shred. For others, it&apos;s the songwriting,
          traditional in style but topical in substance. Sometimes, they
          undeniably snare people with the squad factor - folks see 4 grown
          adults in matching monochrome, and they get curious. The secret,
          according to Fog Holler, is simply that they write and play bluegrass
          in 2024, with similar intention but very different context from the
          genre&apos;s originators. Inspired by a range of influences from The
          Stanley Brothers to Buck Owens to Meshuggah, Fog Holler breathes fresh
          life into well worn forms like the murder ballad and the power waltz.
          Described by two-time Grammy Award Winner Cathy Fink as “The next
          generation of the many shades of grass”, Fog Holler&apos;s captivating
          tunes and coordinated outfits are quickly enthralling longtime
        ...
        >
          The Muddy Souls are a leading progressive/jamgrass band based in
          Eugene, OR featuring original songs, virtuosic improvisation, tight
          vocal harmonies, and a high-octane groove that always has the dance
          floor bouncing. Formed in 2018, the band has four albums of completely
          ...
          Freshgrass, Bridge City Bluegrass, Oregon Country Fair, and
          Wintergrass. They are currently planning their first European Tour for
          2025. A gem of the Northwest music scene the Muddy Souls are sure to
        ...
        >
          ...
          Northwest jamgrass band from Seattle, Washington is an organic
          offshoot of Ballard&apos;s long-running Conor Byrne Pub bluegrass jam
          formed by members inspired by both bluegrass and jamband music and
          culture. Their unique brand fuses hard driving traditional prowess
          with bold improvisational exploration. This group of accomplished
          musicians channels the Emerald City&apos;s musical roots with a well
          curated selection of bluegrass traditionals, rollicking originals, and
          re-imagined covers.
        </FullArtistBox>
        ...
        >
          ...
          spectrum reaches far and wide, the bluegrass universe is expanding,
        ...
        >
          ...
          indie, what sets the band apart is their intricate instrumentation,
          dual vocal parts, intense improvisational jams, and the fact that
        ...
        >
          ...
          Richards on lead vocals and rhythm guitar, Stephen Freeman Moore on
          lap steel and electric banjo, Christine McAllister on the bass and Don
          Lawry on drums. The group performs original music along with
          traditional folk and bluegrass in a throwback western style
          reinvisioned through the lens of somber indie rock with syrupy reverb
          and delay. Amanda is an award-winning songwriter, producer, director,
          playwright, actor and musician with a naturally large set of
          eyelashes. She has worked in the music industry for 20 years as an
          independent artist with 8 full length, self-released albums under her
          belt and a feature length film poised to release this year. Stephen
          Freeman Moore is a musician &#40;banjo, guitar, lap steel guitar and
          vocals&#41;, producer, composer, actor, music director and music
          instructor from San Diego, CA and we suspect he is secretly running a
        ...
        >
          Thunder Ridge is a straight-ahead bluegrass band from Portland, OR.
          The traditional five-piece band is made up of banjo, guitar, mandolin,
          bass and fiddle. They will steal your heart with hard driving vocal
          harmonies and instrumentals. Allow them to take you down a path of
          yesteryear with a good old fashioned sound inspired by the masters of
        ...
        >
          From the jump, Dadweed have been eager to start something new within
          the Bluegrass genre, taking a non-traditional approach, but always
          finding ways to pay homage to the roots of the genre. Making their
          live performances fun and engaging for both lovers of Bluegrass, and
          for those not so interested or familiar with the genre Influenced by
          different generations of bluegrass, from Tony Rice to Billy Strings,
          all 3 members are songwriters and have a great ear for serving songs,
          while also leaning into experimentation and the freewheeling
          exploration of finding new moments not only in their original music,
          but also for their arrangements of covers as well. Dadweed showcases
          two guitars and bass, which allows a lot of room for interplay and
          improvisation. Having less moving parts at any given moment than other
          Bluegrass lineups. All of the members being multi-instrumentalists
          also allows them to swap out a guitar for a dobro, pedal steel,
        ...
        >
          Back in 2018, banjo music innovator Tom Nechville joined forces with
          his musical soulmate, Linda Leavitt and their mutual musical journey
          began. Linda&apos;s experience as a lead singer in several
          Portland-area bluegrass bands, including Mountain Honey, and her
          southern gospel bluegrass roots and soulful voice meet Tom&apos;s
          heartfelt baritone and his inventive multi-genre Scruggs/Melodic style
          banjo playing. Their mix draws from Bluegrass, Classic Country,
          originals and 70&apos;s one hit wonders. Join The Lois & Clark
        ...
        >
          Sunny South is a bluegrass band playing in the Portland, Oregon
          region. Sunny South plays bluegrass with an emphasis on traditional
          style like Flatt and Scruggs, Doc Watson and Bill Monroe. Sunny South
          started playing in the 80's with Sonny Hammond as lead singer and band
          leader. They played all over the pacific northwest and produced two
          albums. After Sonny passed on, the band has continued playing
          bluegrass and honoring Sonny. Mike and Dave are founding members of
          Sunny South and have added Steve Reischman, Dee Johnson and Aaron
          Stocek to fill out the band. Sunny South is an experienced band, both
          professional and comfortable on the stage. They put on a great show
